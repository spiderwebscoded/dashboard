...
import { HeartPulse, ArrowRight, Sun, Moon, Quote, Menu, X } from 'lucide-react';
...
import { mockProjects, mockTeamMembers, mockTasks, mockClients, mockAnalytics } from '@/data/healthcareMockData';
...
const Healthcare = () => {
  ...
  const revenueData = [
    { month: 'Jan', revenue: 52000, projects: 4 },
    { month: 'Feb', revenue: 55000, projects: 4 },
    { month: 'Mar', revenue: 58000, projects: 4 },
    { month: 'Apr', revenue: 56000, projects: 4 },
    { month: 'May', revenue: 60000, projects: 4 },
    { month: 'Jun', revenue: 62000, projects: 4 },
  ];

  const features = [
    {
      title: 'Patient Program Management',
      description: 'Coordinate patient care programs, track treatment initiatives, and manage healthcare facility projects.',
      component: PreviewClients,
      data: { clients: mockClients },
    },
    {
      title: 'Healthcare Staff Coordination',
      description: 'Manage medical staff schedules, track certifications, coordinate shifts, and optimize resource allocation.',
      component: PreviewTeam,
      data: { teamMembers: mockTeamMembers },
    },
    {
      title: 'Clinical Task Organization',
      description: 'Organize patient care tasks, schedule procedures, track compliance requirements, and coordinate care teams.',
      component: PreviewTasks,
      data: { tasks: mockTasks },
    },
    {
      title: 'Healthcare Analytics',
      description: 'Monitor patient satisfaction, track facility metrics, analyze care quality, and measure operational efficiency.',
      component: PreviewAnalytics,
      data: { stats, revenueData },
    },
    {
      title: 'Healthcare IT Projects',
      description: 'Manage EHR implementations, coordinate system upgrades, and deliver healthcare technology projects.',
  ...
  const benefits = [
    {
      ...
      description: 'Better coordination improves care quality',
    },
    {
      stat: '45%',
      label: 'Efficiency Gains',
      description: 'Streamlined workflows save valuable time',
    },
    {
      stat: '100%',
      label: 'HIPAA Compliant',
      description: 'Secure platform meets all compliance needs',
    },
  ];

  const testimonial = {
    quote: "SpiderWebsCoded transformed how we manage our healthcare projects. Staff coordination is seamless and we've seen measurable improvements in patient care.",
  ...
  return (
    ...
    >
      ...
      <IndustryHero
        ...
        description="Specialized project management tools for healthcare organizations to coordinate staff, improve patient care, and ensure compliance."
        icon={HeartPulse}
        stats={[
          { label: 'Healthcare Projects', value: '3,200+' },
          { label: 'Medical Facilities', value: '420+' },
            ...
            {benefits.map((benefit, index) => (
              ...
              >
                <CardContent className="p-8 text-center">
                  <div
                    className={`text-5xl font-bold mb-3 bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent`}
                  >
                    {benefit.stat}
                  </div>
                  <h3
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Join healthcare organizations delivering better outcomes with
            SpiderWebsCoded
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/login" state={{ isSignUp: true }}>
              <Button
                size="lg"
                className="bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-12 py-8 text-xl rounded-2xl shadow-2xl"
              >
                Start Free Trial
